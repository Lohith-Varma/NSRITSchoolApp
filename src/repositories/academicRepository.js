...
export const academicRepository = {
  ...
  async getSections({branchId, academicYear = currentAcademicYear(), limit = 100, offset = 0}) {
  ...
  async getSectionsByClassAndYear({branchId, academicClassId, academicYear = currentAcademicYear()}) {
